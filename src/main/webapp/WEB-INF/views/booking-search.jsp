...
<c:if
	test="${sessionScope.currentuser.memberType=='admin' || sessionScope.currentuser.memberType=='member'}">
	<form:form method="POST" modelAttribute="booking"
		...
		<div class="container">
				...
				<div class="col-9" style="margin: auto; padding-top: 29px;">
					<div style="">
						<div class="dropdown" style="margin-right: 10px; width: 35%;">
							...
							<select name="facilityId" class="form-control float-left"
						...
						<div class="form-group">
							<input class="form-control"
								style="width: 30%; display: inline-block; margin-left: 5px; margin-right: 3px;"
								id="datepicker" type="date" name="bookingdate"
								required="required"><i
								style="display: inline-block; vertical-align: middle !important; margin: auto; padding-bottom: 7px;"
			...
			<div class="features-boxed"
				style="border: 1px solid #eeeeee; background-color: #fff;">
				<div class="container">
					<div class="intro">
					<br>
						...
						<div class="col-sm-6 col-md-5 col-lg-4 item">
							<div class="box">
								<img style="width: 270px; height: 180px;"
									src="${pageContext.request.contextPath}/image/AVdERWQ.jpg">
								<h3>Basketball</h3>
							</div>
						</div>
						<div class="col-sm-6 col-md-5 col-lg-4 item">
							<div class="box">
								<img style="width: 270px; height: 180px;"
									src="${pageContext.request.contextPath}/image/meeting1.jpg">
								<h3>Meeting Room</h3>
							</div>
						</div>
						<div class="col-sm-6 col-md-5 col-lg-4 item">
							<div class="box">
								<img style="width: 270px; height: 180px;"
									src="${pageContext.request.contextPath}/image/tennis.jpg">
								<h3>Tennis</h3>
							</div>
						</div>
					</div>
